...
def process_text():
    try:
        ...
        if detect_headings:
            ...
            processed_word_objects = preprocessor.preprocess_with_headings(
                words_with_meta
            )
        ...
        stats = {
            ...
            "estimated_time_300wpm": round(
                preprocessor.estimate_reading_time(len(processed_words), 300), 1
            ),
            "estimated_time_500wpm": round(
                preprocessor.estimate_reading_time(len(processed_words), 500), 1
            ),
        }
